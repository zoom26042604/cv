...
export const cvDataAdminSys: CVData = {
    personal: {
        name: 'Nathan FERRE',
        title: "Recherche d'alternance - Administrateur Système",
        subtitle: "Rythme: 2 semaines en entreprise, 1 semaine à l'école dès septembre 2026",
        email: 'contact@nathan-ferre.fr',
    ...
    education: [
        {
            ...
            degree: 'Bachelor',
            field: 'Informatique - Infrastructure & Réseau',
            location: 'Toulouse, France',
            startDate: 'sept. 2024',
            endDate: 'juill. 2027',
        },
